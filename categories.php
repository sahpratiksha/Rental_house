				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="name" id="name"pattern="[A-Za-z]+" title="Only alphabets are allowed" required>
							</div>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-primary delete_category" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
  document.getElementById('name').addEventListener('input', function() {
    ...
    if (/[^a-zA-Z]/.test(value)) {
        errorMessage.textContent = "Error: Only letters are allowed.";
